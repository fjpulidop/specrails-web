...
└────┴─────────────────────────────────────────────────┴──────┘
  ...
  │ • + add project                                       │ • Jobs
  │ • Docs · Hub Analytics · Hub Settings                 │ • Analytics
                                                          │ • Settings
```

- **ArcSidebar (left)** — collapsed to a narrow strip by default. Hover to expand and see project names; pin it open with the pin icon at the top. Lists every registered project plus the hub-level entries (Docs, Hub Analytics, Hub Settings).

...
export const AGENTS: AgentEntry[] = [
  ...
  },
  {
    name: "Merge Resolver",
    model: "Sonnet",
    primaryJob: "AI-resolves worktree merge conflicts",
    desc: "Analyzes conflict markers with spec context bundles, auto-resolving where confidence is high and flagging the rest for review",
    stage: "review",
    category: "engineering",
    docsSlug: "agents",
    icon: GitMerge,
  ...
  },
  {
    ...
    model: "Sonnet",
    primaryJob: "Benchmarks code paths for regressions",
    desc: "Benchmarks modified code paths and compares against configured thresholds, reporting performance regressions before ship (measures only)",
    stage: "review",
    category: "quality",
    docsSlug: "agents",
    icon: Gauge,
  ...
  },
  {
    ...
    model: "Sonnet",
    primaryJob: "OWASP scan, credential audit, shipping block",
    desc: "Security auditor. Scans 11 credential patterns and OWASP vulnerabilities. Can BLOCK shipping",
    stage: "review",
    category: "security",
    docsSlug: "agents",
    icon: Shield,
